...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.textEdit.setGeometry(QRect(30, 20, 341, 241))
        self.textEdit_2 = QTextEdit(self.centralwidget)
        self.textEdit_2.setObjectName(u"textEdit_2")
        self.textEdit_2.setGeometry(QRect(450, 20, 321, 241))
        self.pushButton = QPushButton(self.centralwidget)
        self.pushButton.setObjectName(u"pushButton")
        self.pushButton.setGeometry(QRect(344, 270, 131, 51))
        ...
        self.tableWidget.setGeometry(QRect(150, 330, 491, 192))
    ...
    def retranslateUi(self, MainWindow):
        ...
        ___qtablewidgetitem2.setText(QCoreApplication.translate("MainWindow", u"Lexema", None));
    # retranslateUi
